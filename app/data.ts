...
import footerContent from "../public/assets/content/PT/footer/index.json"
import headerContent from "../public/assets/content/PT/header/index.json"
import aboutContent from "../public/assets/content/PT/about/index.json"

export async function getFooter(query?: string | null) {
  await new Promise((resolve) => setTimeout(resolve, 500))
  return footerContent
}

export async function getHeader(query?: string | null) {
  await new Promise((resolve) => setTimeout(resolve, 500))
  return headerContent
}

export async function getAbout(query?: string | null) {
  await new Promise((resolve) => setTimeout(resolve, 500))
  return aboutContent
}
